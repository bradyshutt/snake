...
function NextColor() {
   ...
   let colors = ['#FF0000', '#FF1D00', '#FF3B00', '#FF5900', '#FF7700', '#FFA400', '#FFD100', '#FFFF00', '#AAFF00', '#55FF00', '#00FF00', '#00FF55', '#00FFAA', '#00FFFF', '#00AAFF', '#0055FF', '#0000FF', '#5500FF', '#AA00FF', '#FF00FF'];
   let colorIndex = 0;
